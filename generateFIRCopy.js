...
export const generateFIRCopy = async (caseItem) => {
    ...
    doc.text('DiGiPo Other Case Copy', 105, 25, { align: 'center' });
    ...
    doc.text('Other Case Report', 105, 50, { align: 'center' });
    ...
    doc.text(`Nature of Crime: ${caseItem.individualdetails?.natureOfCrime || 'Not Provided'}`, 20, 110);
    ...
    doc.text('Important Note: This is a Other case. Ongoing investigation is in progress to rescue the victim and apprehend the suspects.', 20, 230, { maxWidth: 180 });
